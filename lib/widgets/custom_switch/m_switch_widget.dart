...
class _CupertinoSwitchState extends State<MCupertinoSwitch> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(MCupertinoSwitch oldWidget) {
...
class _RenderCupertinoSwitch extends RenderConstrainedBox {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    final double currentThumbExtension = MCupertinoThumbPainter.extension * currentReactionValue;
    ///这里的-1.5只是为了圆点距左边无边界，如果没有此需求可以去掉
    final double thumbLeft = lerpDouble(
      trackRect.left + _kTrackInnerStart - MCupertinoThumbPainter.radius - 1.5,
      trackRect.left + _kTrackInnerEnd - MCupertinoThumbPainter.radius - currentThumbExtension,
      visualPosition,
    );
    ///同上
    final double thumbRight = lerpDouble(
      trackRect.left + _kTrackInnerStart + MCupertinoThumbPainter.radius + currentThumbExtension,
      trackRect.left + _kTrackInnerEnd + MCupertinoThumbPainter.radius + 1.5,
      visualPosition,
    );
    final double thumbCenterY = offset.dy + size.height / 2.0;
    final Rect thumbBounds = Rect.fromLTRB(
      thumbLeft,
      thumbCenterY - MCupertinoThumbPainter.radius,
      thumbRight,
      thumbCenterY + MCupertinoThumbPainter.radius,
    );
