...
class _IndicatorPainter extends CustomPainter {
  ...
  Rect indicatorRect(Size tabBarSize, int tabIndex) {
    ...
    ///滑动条的宽和高
    double indicatorWidth = 29;
    double indicatorHeight = 6;
    ...
    final RRect rrect = RRect.fromRectAndRadius(rect, Radius.circular(tabBarSize.height / 2));
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final RRect fromRect = RRect.fromRectAndRadius(indicatorRect(size, from), Radius.circular(size.height / 2));
    final RRect toRect = RRect.fromRectAndRadius(indicatorRect(size, to), Radius.circular(size.height / 2));
    _currentRect = RRect.lerp(fromRect, toRect, (value - from).abs());
    ...
    ///画线
    canvas.drawRRect(_currentRect, Paint()..color = indicatorColor);
  }
...
class _TabBarScrollPosition extends ScrollPositionWithSingleContext {
  ...
  final _CustomTabBarWidgetState tabBar;
...
class CustomTabBarWidget extends StatefulWidget implements PreferredSizeWidget {
  ...
  ///tabbar的高度，正常页面是130.sp，在navigationbar上大概110.sp
  final double height;
